...
public class DataSource {
    ...
    public static List<Movie> getBestMovies(){
        ...
        //adding data
        lstMovies.add(new Movie("john wick", "A wrong-number text sparks a virtual romance between a smart but unpopular teen and a sweet jock who thinks he's talking to a gorgeous cheerleader.","2018",
